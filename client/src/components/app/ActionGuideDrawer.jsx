...
function StepList({ steps }) {
    return (
        <List spacing="3">
            {steps.map((step, idx) => (
                <ListItem key={idx} display="flex" gap="3">
...
function CprTimer() {
    ...
    const progressValue =
        ((phaseDuration - state.remaining) / phaseDuration) * 100;
    ...
    return (
        ...
        >
            ...
            <Text fontSize="xs" color="fg.muted">
                Stay on the beat: 30 compressions (~20s) then 2 breaths (~6s). Repeat
                without long pauses.
            </Text>
        </Stack>
    );
                ...
                <DrawerBody>
                    <Tabs variant="enclosed" colorPalette="blue">
                        <TabList>
                            ...
                            <Tabs gap="2">Defibrillator</Tabs>
                            <Tabs gap="2">Heimlich</Tabs>
                        </TabList>
                        <TabPanels pt="4">
                            <TabPanel>
                                <Stack spacing="4">
                                    <Stack spacing="1">
                                        ...
                                        <Text color="fg.muted" fontSize="sm">
                                            Use a hard surface, minimize pauses, switch rescuers every
                            ...
                            <TabPanel>
                                <Stack spacing="4">
                                    <Stack spacing="1">
                                        ...
                                        <Text color="fg.muted" fontSize="sm">
                                            Follow device prompts; resume compressions immediately
                                            after any shock.
                                        </Text>
                                    </Stack>
                            ...
                            <TabPanel>
                                <Stack spacing="4">
                                    <Stack spacing="1">
                                        ...
                                        <Text color="fg.muted" fontSize="sm">
                                            For adults and children over 1 year. For infants, use 5
                                            back blows and 5 chest thrusts instead.
                                        </Text>
                                    </Stack>
